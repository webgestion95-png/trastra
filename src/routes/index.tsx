        ...
        <div className="container mx-auto grid max-w-6xl gap-12 px-4 md:grid-cols-2 md:items-center">
          ...
          <div id="contact" className="rounded-3xl border border-border bg-background p-8 shadow-card">
            ...
            <ul className="mt-6 space-y-3 text-sm">
              <li className="flex items-center gap-3"><Mail className="h-4 w-4 text-accent" /><a href="mailto:support@trastra.myinvest-capital.com" className="hover:text-accent">support@trastra-bank.com</a></li>
          ...
          <div className="grid gap-6 sm:grid-cols-2 md:grid-cols-4">
            ...
            <div>
              ...
              <ul className="mt-3 space-y-2">
                ...
                <li><a href="mailto:support@trastra.myinvest-capital.com" className="hover:text-accent">support@trastra-bank.fr</a></li>
